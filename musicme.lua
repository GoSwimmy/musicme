...
-- Options
local version = "1.0.0"
local repo = "https://raw.githubusercontent.com/GoSwimmy/musicme/master/index.json"
...
local function update()
    shell.run("wget run https://raw.githubusercontent.com/GoSwimmy/musicme/master/install.lua")
end
